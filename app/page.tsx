...
export default function Home() {
  ...
  return (
    <div className="relative bg-[#090909] text-white overflow-x-hidden font-sans">
      ...
      {/* About Section */}
      <section className="relative z-20 w-full bg-[#090909] px-6 md:px-12 lg:px-24 pt-16 pb-16">
        ...
        <motion.div 
          ...
          className="max-w-[1200px] w-full flex flex-col items-center relative z-10 mx-auto space-y-12"
        >
          {/* Section Sub-header */}
